...
TEST_IMAGE_PATHS = [os.path.join(PATH_TO_TEST_IMAGES_DIR, 'image{}.jpg'.format(i)) for i in range(1, NUMBER_TEST_IMAGES+1)]
...
with detection_graph.as_default():
    with tf.Session(graph=detection_graph) as sess:
        for image_path in TEST_IMAGE_PATHS:
            print('Evaluating', MODEL_FOLDER+image_path)
            image = Image.open(MODEL_FOLDER+image_path)
