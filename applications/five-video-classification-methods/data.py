...
class DataSet():
    ...
    def __init__(self, seq_length=40, class_limit=None, image_shape=(224, 224, 3)):
        ...
        self.sequence_path = data_folder_path+'/data/sequences/'
    ...
    def get_data():
        ...
        with open(data_folder_path+'/data/data_file.csv', 'r') as fin:
            reader = csv.reader(fin)
            data = list(reader)

        new_data = [s for s in data if s[0] != '']
    ...
    def get_frames_for_sample(sample):
        ...
        filenames."""
        path = data_folder_path+'/data/' + sample[0] + '/' + sample[1] + '/'
        filename = sample[2]
